...
- **Breaking News** - visar de senaste modenyheterna
...
- Hur man bygger en responsiv layout med flexbox
- Hantering av interaktivitet med enkel JavaScript (hamburgermeny)
- Användning av Google Fonts och CSS-variabler för färg och typografi
- Strukturering av en nyhetssida med huvudartiklar och sidopanel